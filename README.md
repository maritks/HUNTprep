...
for(i in 1:length(CA_chrom)){                                      # A for-loop which makes a SNP-vector for 
  ...
  assign(nam, listt)
  CAlist <- append(CAlist, list(listt))
}
...
for(i in 1:length(MI_chrom)){
  ...
  assign(nam, listt)
  MIlist <- append(MIlist, list(listt))
}
...
for(i in 1:length(OI_chrom)){
  ...
  assign(nam, listt)
  OIlist <- append(OIlist, list(listt))
}
...
for(i in 1:length(IHD_chrom)){
  ...
  assign(nam, listt)
  IHDlist <- append(IHDlist, list(listt))
}
...
for(i in 1:length(AP_chrom)){
  ...
  assign(nam, listt)
  APlist <- append(APlist, list(listt))
}
...
for(i in 1:length(PHD_chrom)){
  ...
  assign(nam, listt)
  PHDlist <- append(PHDlist, list(listt))
}
...
write.table(CAsnp, file = "CAsnps.txt", sep = "\t", row.names = F, col.names = F) # all SNPs
...
write.table(MIsnp, file = "MIsnps.txt", sep = "\t", row.names = F, col.names = F)
...
write.table(OIsnp, file = "OIsnps.txt", sep = "\t", row.names = F, col.names = F)
...
write.table(APsnp, file = "APsnps.txt", sep = "\t", row.names = F, col.names = F)
...
write.table(PHDsnp, file = "PHDsnps.txt", sep = "\t", row.names = F, col.names = F)
